...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  if (message.action === "analyzeText") {
    ...
    // GPT API 호출
    const OPENAI_API_KEY = "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";
   ...
   body: JSON.stringify({
  model: "gpt-3.5-turbo", // 또는 "gpt-4-turbo"로 시도
